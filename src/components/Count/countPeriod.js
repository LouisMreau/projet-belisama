...
* Construit le nuage de points pour le taux de comptage et appelle ChartCViewer pour afficher les deux graphiques côte à côte
**/
...
const CountPeriod = (props) => {
  ...
  const setCountSerie = (dataLean) => {
    ...
    let data1 = loadCountSerie(dataLean,start_energy, end_energy,start_time1,end_time1)
    let data2 = loadCountSerie(dataLean,start_energy, end_energy,start_time2,end_time2)
        ...
        <Grid container className="count-container">
          ...
          <Grid container justify = 'center' alignItems = 'center' >
            ...
            <Grid item xs={12} sm = {9}>
              ...
              <ChartPeriod data1 = {countData1} data2 = {countData2} startDate1 = {startDate1} startDate2 = {startDate2} endDate1 = {endDate1} endDate2 = {endDate2}/>
            </Grid> 
            <Grid  xs={12} sm = {9}>  
              <Box margin = '2em' color = 'white'>
                </Box>
