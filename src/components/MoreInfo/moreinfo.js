...
import {Grid, Container, Button, Paper, Box, Typography, CircularProgress, IconButton, Hidden} from '@material-ui/core';
    ...
    <Grid container justify = 'center'>
        ...
        <Grid item xs = {12}>
            ...
            <Typography variant = 'body2'>
                Pour plus d'informations, veuillez contacter Philippe Laurent à l'adresse suivante : philippe.laurent@cea.fr
            </Typography>
            <Box margin = '2em'></Box>
        </Grid>
        <Hidden xsDown>
        <Grid item xs = {12}>
            ...
            <TimelineItem>
                ...
                <TimelineContent>
                    ...
                    <CardContent>
                    <Typography className={classes.title}variant="h6" component="h1" align = 'left'>
                    Création
                    </Typography>
                    <Typography align = 'left'>
                    Le projet Belisama voit le jour au sein du laboratoire de l'APC (AstroParticule et Cosmologie)
                    </Typography>
                    </CardContent>
            ...
            <Grid>
            <Box margin = "1em">
            <Typography variant = 'overline' color="textSecondary" className={classes.title}>Etape 1</Typography>
            </Box>
            <Card className={classes.root}>
                <CardMedia>
                    <img src = {logo} height = '150'/>
            ...
            <Box margin = "1em">
            <Typography variant = 'overline' color="textSecondary" className={classes.title}>Etape 2</Typography>
            </Box>
                    <Card className={classes.root}>
                    <CardMedia align = 'center'>
                        <img  src = {detecteur} width = '75%'/>
            ...
            <Box margin = "1em">
            <Typography variant = 'overline' color="textSecondary" className={classes.title}>Etape 3</Typography>
            </Box>
                <Card className={classes.root}>
                    <CardMedia align = 'center'>
                        <img  src = {video} width = '75%'/>
                ...
                <Box margin = '1em'>
                <Typography variant = 'overline' color="textSecondary" className = {classes.title}>Etape 4</Typography>
                </Box>
                <Card className={classes.root}>
                    <CardContent>
                    <Typography className={classes.title} variant="h6" component="h1" align = 'left'>
